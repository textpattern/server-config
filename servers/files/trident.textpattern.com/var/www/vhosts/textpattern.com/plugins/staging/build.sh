...
git clone --branch 'master' --depth 1 --single-branch https://github.com/textpattern/textpattern-library-of-plugins.git /var/www/vhosts/textpattern.com/plugins/staging/_github
