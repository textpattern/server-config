...
git clone --branch '4.7.x' --depth 1 --single-branch https://github.com/philwareham/textpattern-classic-admin-theme.git /var/www/vhosts/textpattern.com/design-patterns-classic-4-7/staging/_github
